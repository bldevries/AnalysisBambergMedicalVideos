...
#
#
def compare_detections(df1, df2, key1, key2, key_index="au", room=0):
# def compare_detections(df_predictions = df1, df_groundtruth = df2, 
#                         key_predictions = key1, key_groundtruth = key2, 
#                         key_index="au", room=0):    
    """
    ...
    if total1 ==0:
        nr_in_1_also_found_in_2 = 0
    else:
        nr_in_1_also_found_in_2 = found12/total1
    if total2 ==0:
        nr_in_2_also_found_in_1 = 0
    else:    
